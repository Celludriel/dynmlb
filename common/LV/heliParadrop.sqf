/*
		...
		Calling the script:
			...
			default: 		nul = [this] execVM "common\LV\heliParadrop.sqf";
			...
			custom: 		nul = [spot, side, allowDamage, captive, distance, direction, flyby, fly height, jump distance,
								...
								group, custom init, ID, MP] execVM "common\LV\heliParadrop.sqf";
...
EXAMPLE: 	nul = [player, 2, false, true, 1000, "random", true, 500, 200, 6, 1, 50, true, false, true, true, player, false, 0.75, nil, nil, 1,false] execVM "common\LV\heliParadrop.sqf";
*/
