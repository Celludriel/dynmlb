/*
		...
		Calling the script:
				...
				default: 	nul = [] execVM "common\LV\ambientCombat.sqf";
				custom: 	nul = [min range, max range, min delay, max delay, groups, side ratios, center unit, AI skills,
								communication, dissapear distance, custom init, patrol type, MP] execVM "common\LV\ambientCombat.sqf";
	...
	Parameters:
		...
		Fully customized example:
				nul = [150,600,10,30,8,[0,1,1],player,[0.2,0.3,0.1,0.55,0.25,1,1,0.25,1,1],1,800,"hint format['spawning unit: %1',this];",
					["AWARE","SAD"],false] execVM "common\LV\ambientCombat.sqf";
...
if(isNil("LV_fullLandVehicle"))then{LV_fullLandVehicle = compile preprocessFile "common\LV\LV_functions\LV_fnc_fullLandVehicle.sqf";};
if(isNil("LV_fullAirVehicle"))then{LV_fullAirVehicle = compile preprocessFile "common\LV\LV_functions\LV_fnc_fullAirVehicle.sqf";};
if(isNil("LV_fullWaterVehicle"))then{LV_fullWaterVehicle = compile preprocessFile "common\LV\LV_functions\LV_fnc_fullWaterVehicle.sqf";};
if(isNil("LV_menGroup"))then{LV_menGroup = compile preprocessFile "common\LV\LV_functions\LV_fnc_menGroup.sqf";};
if(isNil("LV_diveGroup"))then{LV_diveGroup = compile preprocessFile "common\LV\LV_functions\LV_fnc_diveGroup.sqf";};
if(isNil("LV_ACpatrol"))then{LV_ACpatrol = compile preprocessFile "common\LV\LV_functions\LV_fnc_ACpatrol.sqf";};
if(isNil("LV_ACcleanUp"))then{LV_ACcleanUp = compile preprocessFile "common\LV\LV_functions\LV_fnc_ACcleanUp.sqf";};
if(isNil("LV_ACskills"))then{LV_ACskills = compile preprocessFile "common\LV\LV_functions\LV_fnc_ACskills.sqf";};
if(_communication == 1)then{if(isNil("LV_AIcommunication"))then{LV_AIcommunication = compile preprocessFile "common\LV\LV_functions\LV_fnc_AIcommunication.sqf";};};
if(isNil("LV_vehicleInit"))then{LV_vehicleInit = compile preprocessFile "common\LV\LV_functions\LV_fnc_vehicleInit.sqf";};
if(isNil("LV_RandomSpot"))then{LV_RandomSpot = compile preprocessFile "common\LV\LV_functions\LV_fnc_randomSpot.sqf";};
if(_mp)then{if(isNil("LV_GetPlayers"))then{LV_GetPlayers = compile preprocessFile "common\LV\LV_functions\LV_fnc_getPlayers.sqf";};};
if(isNil("LV_FindLandPosition"))then{LV_FindLandPosition = compile preprocessFile "common\LV\LV_functions\LV_fnc_findLandPosition.sqf";};
if(isNil("LV_IsInMarker"))then{LV_IsInMarker = compile preprocessFile "common\LV\LV_functions\LV_fnc_isInMarker.sqf";};
