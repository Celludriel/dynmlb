...
//Syntax: nul = [handle,style,syncedUnit,range/delay,flee direction] execVM "common\LV\LV_functions\LV_fnc_removeAC.sqf";
//*handle = the name of ambientCombat, ex: war = [this] execVM "common\LV\ambientCombat.sqf"; <-war is the handle
...
LV_deleteOnDestination = compile preprocessFile "common\LV\LV_functions\LV_fnc_deleteOnDestination.sqf";
LV_killAfterDelay = compile preprocessFile "common\LV\LV_functions\LV_fnc_killAfterDelay.sqf";
