...
initial version by SPUn / lostvar
	...
	nul = [[script parameter list], distance, keep count] execVM "common\LV\LV_functions\LV_fnc_simpleCache.sqf";
	...
	nul = [[[1, [<parameter for 1>]], [2, [<parameter for 2>]]], 500, true] execVM "common\LV\LV_functions\LV_fnc_simpleCachev2.sqf";

	example 2 (for use in init.sqf or initServer.sqf):
	LV_fnc_simpleCachev2 = compileFinal preProcessFileLineNumbers "common\LV\LV_functions\LV_fnc_simpleCachev2.sqf";
...
if(isNil {LV_fnc_removeGroupv2}) then {LV_fnc_removeGroupv2 = compileFinal preProcessFileLineNumbers "common\LV\LV_functions\LV_fnc_removeGroupv2.sqf";};
if(isNil {NP_fnc_isPlayernear}) then {NP_fnc_isPlayernear = compileFinal preProcessFileLineNumbers "common\LV\LV_functions\NP_fnc_isPlayernear.sqf";};
if(isNil {LV_militarize}) then {LV_militarize = compileFinal preProcessFileLineNumbers "common\LV\militarize.sqf";};
if(isNil {LV_fillHouse}) then {LV_fillHouse = compileFinal preProcessFileLineNumbers "common\LV\fillHouse.sqf";};
