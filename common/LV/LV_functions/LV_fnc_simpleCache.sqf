/*ARMA3Alpha function LV_fnc_simpleCache v0.6 - by SPUn / lostvar
	...
	nul = [[ID's],[players],distance,keep count,MP] execVM "common\LV\LV_functions\LV_fnc_simpleCache.sqf";
	...
	nul = [[13,14],[playerUnit1],500,true,false] execVM "common\LV\LV_functions\LV_fnc_simpleCache.sqf";
