...
//*Syntax: nul = [this] execVM "common\LV\patrol-vD.sqf";
//     or: nul = [this,center position,radius,handle doors] execVM "common\LV\patrol-vD.sqf";
...
if(isNil("LV_CloseDoors"))then{LV_CloseDoors = compile preprocessFile "common\LV\LV_functions\LV_fnc_closeDoors.sqf";};
